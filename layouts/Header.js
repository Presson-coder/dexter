            ...
            <div className="offcanvas__content">
              <div className="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
                <div className="offcanvas__logo">
                  <Link href="/" style={{ fontSize: 30, color: "black" }}>
                    YpoTerra Technologies
                  </Link>
                </div>
              ...
              <p className="text d-none d-xl-block mb-5">
                YpoTerra Technologies is a Company that specializes in
                underground mine shaft inspections using drones. We also offer
                IoT sensors, Drones / Fitted, Cameras for surveillance and
              ...
              <div className="offcanvas__contact">
                ...
                <ul>
                  ...
                  <li className="d-flex align-items-center">
                    ...
                    <div className="offcanvas__contact-text">
                      <a href="tel:+11002345909">+263 78 641 5166</a>
                    </div>
                  </li>
                </ul>
            ...
            <div className="header-main">
              <div className="sticky-logo">
                <Link href="/" className="">
                  <p
                    style={{ fontSize: 30 }}
                    className="text-white text-xl font-weight-bold "
                  >
                    YpoTerra
                  </p>
                </Link>
              ...
              <div className="header-right d-flex justify-content-end align-items-center">
                <div className="icon-items">
                  ...
                  <div className="content">
                    <p>Make A Call</p>
                    <h4>
                      <a href="tel:+00012345688">+263 78 641 5166 </a>
                    </h4>
                  </div>
                </div>
